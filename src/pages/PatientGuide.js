...
import Bg from '../images/guide.webp'
        ...
        <div className="row">
          <aside className="col-md-4 col-lg-3">
            <div className="list-group mb-5  with-shadow">
              <Link to='/about' className='list-group-item list-group-item-action action1' href="">РУКОВОДСТВО ДЛЯ ПАЦИЕНТОВ</Link>
              <Link to='/news' className='list-group-item list-group-item-action' href="">GREENLINES Health Point  </Link>
              <Link to='/' className='list-group-item list-group-item-action' href="">Международные страховые компании </Link>
            </div>
